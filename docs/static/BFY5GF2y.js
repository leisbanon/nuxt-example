import{E as f}from"./Cj9HpjRr.js";import"./B8Uhqbzv.js";import{a as y}from"./B4_qRzbU.js";import{u as s}from"./CKhxj4Eh.js";import{J as v,t as c,x as e,B as t,z as u,A as i,v as g}from"./-izJgR3p.js";const T={__name:"3-网络请求",async setup(b){let o,l;y({title:"网络请求"});const{data:d}=([o,l]=v(()=>s("/api/hello","$ZDT6aQ9wYE")),o=await o,l(),o);console.log("a => ",d.value);const p=async()=>{const{data:a}=await s("/api/getUserInfo?name=leisbanon","$fX3osjGNux");console.log(a.value)},m=async()=>{const{data:a}=await s("/api/setUserInfo",{method:"POST",body:{name:"Hello Leisbanon"}},"$oG-GVZVZz4");console.log(a.value)};return(a,n)=>{const r=f;return g(),c("ul",null,[n[8]||(n[8]=e("li",null,[e("strong",null,"网络请求 - 服务"),e("p",null,"Nuxt 会自动扫描 server 目录中的文件，注册 API 调用和服务器处理程序；"),e("p",{class:"mb-[12px]"},"每个文件都应该导出一个定义的默认函数，defineEventHandler(), 函数可以处理返回 json 数据，或者发送响应；"),e("p",null,"服务器路由：server/api/hello.js"),e("pre",null,[t("          "),e("code",null,`
            // server/api/hello.js
